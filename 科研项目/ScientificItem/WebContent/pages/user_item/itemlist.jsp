...
<body>
	...
	<span class="c-gray en">&gt;</span> 员工项目管理 <span class="c-gray en">&gt;</span>
				...
				<c:forEach items="${items}" var="que" varStatus="status">
					...
					<!-- 是否替换为课程和章节 -->
							<td class="f-14">
								...
								<a title="修改" href="javascript:;" onclick="paper_edit('修改','UpdateItemUIServlet?Id=${que.item_id}','','500','700')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont"></i></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a title="删除" href="DeleteItemServlet?Id=${que.item_id}" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont" onclick="return confirmd()" >&#xe6e2;</i></a>
							</td>
						</tr>
					</tbody>
				</c:forEach>
