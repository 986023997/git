...
<body>
<div class="pd-20">
  <form action="<%=basePath%>UpdateItemServlet"  method="post" class="form form-horizontal" id="form-member-add">
    <input type="hidden" name="Item_id" value="${item.item_id }">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>项目名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${item.item_name}" placeholder="输入要创建的项目名称" id="Item_name" name="Item_name" datatype="*2-16" nullmsg="项目名不能为空">
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${item.item_topic}" placeholder="申请的主题"  id="Item_topic" name="Item_topic" datatype="*" nullmsg="主题不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${item.item_fund}" placeholder="资金"  id="Item_fund" name="Item_fund" datatype="n" nullmsg="项目名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${item.item_date}" placeholder="日期"  id="Item_date" name="Item_date" datatype="*" nullmsg="日期不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea rows="30" cols="30" class="textarea" name="Item_content" datatype="*" nullmsg="项目名不能为空">${item.item_content}</textarea>
      </div>
      <div class="col-4"> </div>
    </div>
