...
<body>
	<header class="Hui-header cl"> <a class="Hui-logo l"
		title="题库管理平台教师端 v1.0" href="login/login1">管理员端</a> <span
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="" href="javascript:void(0)">查看所有账号信息</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="">
			...
			<dd>
				<ul>
					<li><a _href="courses/getall" href="javascript:void(0)">查看所有部门</a></li>
				</ul>
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="students/getall" href="javascript:void(0)">查看所有角色</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="question_type/showQuestionTypes"
						href="javascript:void(0)">查看所有权限</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
