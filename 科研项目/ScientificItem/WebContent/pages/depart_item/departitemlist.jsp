				...
				<c:forEach items="${items}" var="que" varStatus="status">
					...
					<!-- 是否替换为课程和章节 -->
							<td class="f-14">
								...
								<a title="通过" href="DepartItemCheckServlet?Id=${que.item_id}&status=1" ><i class="Hui-iconfont" onclick="return confirmd()" >通过</i></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a title="拒绝" href="DepartItemCheckServlet?Id=${que.item_id}&status=2" ><i class="Hui-iconfont" onclick="return confirmd()" >拒绝</i></a>
							</td>
						</tr>
					</tbody>
				</c:forEach>
